...
IPv4 ipServer = {192,168,1,99};
unsigned short portServer = DNETcK::iPersonalPorts44 + 444; // port 4444

// Specify the SSID
const char * szSsid = "EESoc";
...
void loop() {
    ...
    case WRITE:
        if(tcpClient.isConnected())
        {
            ...
            String request = "";
            String correctRequest = "SEND_ALL_DATA";
            String data = "Arbitrary String";
            ...
            Serial.println("The received command was:");
...
void readData() {
  ...
  ACC_Temp = analogRead(sensorPinTemp);
  V_Temp = ((float) ACC_Temp)/1024*3.3;
